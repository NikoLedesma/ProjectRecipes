...
explicacion_receta VARCHAR(255) NOT NULL,
calificacion_receta CHAR(1),
usuario_id_fk VARCHAR(30),
grupo_id_fk VARCHAR(30),
PRIMARY KEY(id_receta),
FOREIGN KEY(usuario_id_fk) REFERENCES usuario(id_usuario) ,
FOREIGN KEY(grupo_id_fk) REFERENCES grupo(id_grupo)
)


INSERT INTO receta(nombre_receta,explicacion_receta,calificacion_receta,usuario_id_fk,grupo_id_fk)
			VALUES('fugazzeta','pelar las cebollas , amasar la masa hacer la harina','B','pepe',NULL);
